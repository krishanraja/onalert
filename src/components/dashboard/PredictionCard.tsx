...
export function PredictionCard({ locationIds }: Props) {
  ...
  return (
    <div className="bg-surface rounded-xl border border-border p-4 space-y-3">
      ...
      <p className="text-[10px] text-foreground-muted">Based on 90 days of historical patterns</p>
        ...
        return (
          <div key={i} className="flex items-center justify-between">
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[10px] text-foreground-muted">{pred.predicted_day}s</div>
            </div>
